...
export default function YourItemsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            {/* ✅ Header now matches "Deliver Items" (added shadow!) */}
            ...
            {/* ✅ Keeping your original table styling exactly as it was */}
            <div className="p-6">
                {items.length === 0 ? (
                            ...
                            <tbody className="text-gray-700">
                                {items.map((item, index) => (
                                    <tr key={item._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                        ...
                                        <td className="py-3 px-4 border-b border-gray-300">₹{item.price.toFixed(2)}</td>
                                        <td className="py-3 px-4 border-b border-gray-300">{item.quantity}</td>
